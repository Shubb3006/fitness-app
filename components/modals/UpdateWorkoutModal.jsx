...
const UpdateWorkoutModal = ({ workout, setUpdatingWorkout }) => {
  const { updateWorkout, updatingWorkout } = useWorkoutStore();
  ...
  const handleSubmit = async (e) => {
    ...
    const success = await updateWorkout(workout._id, exercises);
